...
print(f"Parallelism, Executors, Core numbers information about Parquet formatted file:")
...
print(f"========================================================================")
#execute this line for running: `spark-submit .\hdfs_readers\parquet_reader.py`
